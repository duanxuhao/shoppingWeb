            ...
            <div class="confirm-tips">
              ...
              <ul>
                <li class="regi_form_input">
                  ...
                  <input type="text" name="loginname" class="regi_login_input regi_login_input_left" placeholder="User Name" v-model="userName">
                </li>
                <li class="regi_form_input noMargin">
                  <i class="icon IconPwd"></i>
                  <input type="password" name="password" class="regi_login_input regi_login_input_left login-input-no input_text" v-model="userPwd" placeholder="Password" @keyup.enter="login">
                </li>
              </ul>
            </div>
            <div class="login-wrap">
              <a href="/#/cart" class="btn-login" @click = "login">登  录</a>
            </div>
          </div>
        </div>
      </div>
